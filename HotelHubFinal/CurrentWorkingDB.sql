...
--
-- Host: 127.0.0.1
-- Generation Time: May 07, 2020 at 02:13 AM
...
INSERT INTO `book` (`bookID`, `userID`, `roomNumber`, `startDate`, `endDate`) VALUES
(1, 1, 123, '2020-05-08', '2020-05-11'),
(2, 1, 123, '2020-05-13', '2020-05-15');
...
INSERT INTO `comments` (`id`, `email`, `hotelID`, `comment`, `date`) VALUES
(1, 'juanr26690@gmail.com', 1, 'hello', '2020-05-06 23:54:10'),
(2, 'juanr26690@gmail.com', 1, 'Great Stay', '2020-05-07 00:05:01');
...
(6, 'd', 'd', 'd@d.com', '$2y$10$n8IXNyvHMTKEmRAMXJEIbOE8sgAh.g7wGLer3YifvBqJxbXBL1N86', 'N/A');
...
--
ALTER TABLE `hotel`
  MODIFY `hotelID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `comments`
  ADD CONSTRAINT `comments_ibfk_1` FOREIGN KEY (`hotelID`) REFERENCES `hotel` (`hotelID`);
